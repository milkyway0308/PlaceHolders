...
open class WrappedString(val rawString: String, val holders: List<Pair<ArgumentData, AbstractPlaceHolder>>) {
    ...
    override fun toString(): String {
        return "WrappedString(holders=${holders.map { x -> x.second }})"
    }
